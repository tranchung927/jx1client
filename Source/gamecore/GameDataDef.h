...
#define MAX_PLAYER_ITEM                                                                                                \
    (MAX_EQUIPMENT_ITEM + MAX_REPOSITORY_ITEM + MAX_TRADE_ITEM + MAX_TRADE1_ITEM + MAX_IMMEDIACY_ITEM + itempart_num + \
     MAX_HAND_ITEM + MAX_PLAYER_ITEM_RESERVED + MAX_ITEM_BOX + MAX_CAILIAO_ITEM)
