 ...
 */
#if defined(WINCE)
typedef VOID (APIENTRY *PAPCFUNC)(unsigned long dwParam);
#endif
...
struct ptw32_thread_t_
{
  ...
  unsigned long thread;			/* Windows thread ID */
...
( (unsigned long) ( ( (_severity) << 30 ) |     /* Severity code        */ \
            ( 1 << 29 ) |               /* MS=0, User=1         */ \
            ( 0 << 28 ) |               /* Reserved             */ \
...
extern unsigned long (*ptw32_register_cancellation) (PAPCFUNC, HANDLE, unsigned long);
 ...
 */
  ...
  unsigned long
    ptw32_RegisterCancellation (PAPCFUNC callback,
			       HANDLE threadH, unsigned long callback_arg);
  ...
  unsigned long ptw32_relmillisecs (const struct timespec * abstime);
...
#endif
void ptw32_throw (unsigned long exception)
